...
MASTER_GRID_COLS = [
    "Issuer",
    "Insurance/Credit Rating Short Term",
    "Insurance/Credit Rating Long Term",
    "Take FI money?",
    "Available",
    "Province",
    "Offers USD",
...
with tab_data:
    ...
    edited = st.data_editor(
        ...
        column_config={
            ...
            "Insurance/Credit Rating Short Term":      st.column_config.TextColumn("CR Short Term",       width="medium"),
            "Insurance/Credit Rating Long Term":       st.column_config.TextColumn("CR Long Term",        width="medium"),
